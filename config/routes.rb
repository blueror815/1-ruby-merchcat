Myapp::Application.routes.draw do
  ...
  post '/send_email' => 'contact#send_email'

  # Confirmation mailer
  post '/send_confirmation' => 'confirmation#send_confirmation'

  # Shows
  get '/shows' => 'shows#index'
  post '/shows/info' => 'shows#info'
  get '/shows/:id' => 'shows#detail'
  post '/shows/report' => 'shows#report'
  post '/shows/:id/email' => 'shows#email'
  
  # Subscribers
  get '/subscribers' => 'subscribers#index'
  post '/subscribers/info' => 'subscribers#info'

  # Promo codes
  get '/promocode' => 'promocode#index'
  post '/promocode/info' => 'promocode#info'
  get '/promocode/:id' => 'promocode#update'

  # Items
  post '/items/info' => 'items#info'

  # Membership
  post '/membership/upgrade' => 'membership#upgrade_membership'
  post '/membership/retrieve' => 'membership#retrieve_customer'
